...
class _SportPageState extends State<SportPage> {
  ApiSport _apiSport = ApiSport();
  late Map<String, dynamic> _sportData;
  ...
  Future<void> _fetchSportData() async {
    try {
      _sportData = await _apiSport.fetchSportData();
      _filteredAnimeList.addAll(_sportData.entries
