...
class _MoviePageState extends State<MoviePage> {
  ApiMovie _apiAdventure = ApiMovie();
  late Map<String, dynamic> _movieData;
  ...
  Future<void> _fetchMovieData() async {
    try {
      _movieData = await _apiAdventure.fetchMovieData();
      _filteredAnimeList.addAll(_movieData.entries
